...
{
	public partial class Clr2in : PhoneApplicationPage
	{
		String clr2;
		...
		void capture_completed(object sender, PhotoResult e)
		{
			...
			//WB_CapturedImage = new WriteableBitmap(imgOne, null);
		}
		...
		private void capture2(object sender, RoutedEventArgs e)
		{
			try
			{
				CCT.Show();
		...
		public void show_Click(object sender, RoutedEventArgs e)
		{
			...
			clr2 = "#" + rhex + "" + ghex + "" + bhex;
			PhoneApplicationService.Current.State["c2b"] = b;
			PhoneApplicationService.Current.State["c2g"] = g;
			PhoneApplicationService.Current.State["c2r"] = r;
